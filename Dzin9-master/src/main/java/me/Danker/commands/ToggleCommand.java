...
public class ToggleCommand extends CommandBase implements ICommand {
	...
	public static boolean autosimon;
	public static boolean autoterminals;
	public static boolean autoterminals_pingless;
	...
	public void processCommand(ICommandSender arg0, String[] arg1) throws CommandException {
		...
		switch (arg1[0].toLowerCase()) {
			...
			case "test":
				test = !test;
				player.addChatMessage(new ChatComponentText(DankersSkyblockMod.MAIN_COLOUR + "NIGGERS"+"."));
				break;
			case "ghostblock":
				ghostblock = !ghostblock;
				player.addChatMessage(new ChatComponentText(DankersSkyblockMod.MAIN_COLOUR + "ghostblocking is on :)))"+"."));
				break;
			case "caketimer":
