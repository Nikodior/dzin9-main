...
public class DHelpCommand extends CommandBase {
	...
	public void processCommand(ICommandSender arg0, String[] arg1) throws CommandException {
		...
		player.addChatMessage(new ChatComponentText("\n" + EnumChatFormatting.GOLD + " " + DankersSkyblockMod.MODID + " (DzinTuByl-Client) Version " + DankersSkyblockMod.VERSION + "\n" + "\n" +
													...
													EnumChatFormatting.GOLD + DankerGuiCommand.usage(arg0) + EnumChatFormatting.AQUA + " - Opens the GUI for (almost) The Best QOL mod.\n" +
		...
		player.addChatMessage(new ChatComponentText("\n" + EnumChatFormatting.AQUA + "Nigger Nigger ---> " + "NikoClient is the best" + "\n"));
	}
