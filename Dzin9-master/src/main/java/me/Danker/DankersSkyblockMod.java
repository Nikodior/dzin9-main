...
public class DankersSkyblockMod {
    ...
    public static final String MOD_NAME = "Dzin9";
    public static final String VERSION = "1.8.69";
    ...
    public void init(FMLInitializationEvent event) throws UnsupportedAudioFileException, IOException, LineUnavailableException {
        ...
        MinecraftForge.EVENT_BUS.register(new AutoSimon());
    ...
    public void onJoin(EntityJoinWorldEvent event) {
        if (firstLaunch) {
            ...
            IChatComponent chatComponent = new ChatComponentText(
                    EnumChatFormatting.GOLD + "Thank you for downloading DzinTuByl-Client.\n" +
