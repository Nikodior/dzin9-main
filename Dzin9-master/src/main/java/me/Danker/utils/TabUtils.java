...
public class TabUtils
{
  public static final Ordering<NetworkPlayerInfo> playerInfoOrdering = new Ordering<NetworkPlayerInfo>()
    {
      public int compare(NetworkPlayerInfo p_compare_1_, NetworkPlayerInfo p_compare_2_) {
        ...
        (p_compare_2_.getGameType() != WorldSettings.GameType.SPECTATOR)).compare((scoreplayerteam != null) ? scoreplayerteam.getRegisteredName() : "", 
        (scoreplayerteam1 != null) ? scoreplayerteam1.getRegisteredName() : "").compare(p_compare_1_.getGameProfile().getName(), p_compare_2_.getGameProfile().getName()).result();
      }
    };
  ...
  public static List<String> getTabList() {
    return (List<String>)getTabEntries().stream().map(playerInfo -> (Minecraft.getMinecraft()).ingameGUI.getTabList().getPlayerName(playerInfo))
